package com.ishmuradov.otus.homework12.cache;
...
public class CacheImpl<K, V> implements Cache<K, V> {
  ...
  public Map<String, String> getCacheParams() {
    ...
    cacheParams.put("Max elements", String.valueOf(maxElements));
    cacheParams.put("Life time, ms", String.valueOf(lifeTimeMs));
    cacheParams.put("Idle time, ms", String.valueOf(idleTimeMs));
    cacheParams.put("Is ethernal", String.valueOf(isEternal));

    return Collections.unmodifiableMap(cacheParams);
  }
}